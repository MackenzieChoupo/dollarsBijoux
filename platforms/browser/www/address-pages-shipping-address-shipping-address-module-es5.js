...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["address-pages-shipping-address-shipping-address-module"], {
  ...
  function srcAppAddressPagesShippingAddressShippingAddressPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ShippingAddressPage = /*#__PURE__*/function () {
      function ShippingAddressPage(navCtrl, config, http, shared, modalCtrl, loading, userAddress, location) {
      ...
      _createClass(ShippingAddressPage, [{
        ...
        value: function disableButton() {
          if (this.shared.shipping.first_name == "" || this.shared.shipping.last_name == "" || this.shared.shipping.city == "" || this.shared.shipping.postcode == "" || this.shared.shipping.state == "" || this.shared.shipping.country == "" || this.shared.shipping.address_1 == "" || this.shared.shipping.state == null || this.shared.shipping.city == null || this.shared.shipping.postcode == null) {
            return true;
          } else return false;
        }
      }, {
