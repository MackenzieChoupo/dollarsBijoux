...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-detail-product-detail-module"], {
  ...
  function srcAppProductDetailProductDetailModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ProductDetailPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppProductDetailProductDetailPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductDetailPage = /*#__PURE__*/function () {
      function ProductDetailPage(navCtrl, config, shared, modalCtrl, loading, iab, events, storage, http, applicationRef, socialSharing, activatedRoute, router) {
        var _this4 = this;
        ...
        this.fillAttributes = function (val, key, position) {
          ...
          if (count == 0 && val != "choose") this.selectAttributes.push({
            key: key,
            value: val,
            position: position
          });
          this.sortAttributes();
          if (this.getAttributesLength() == this.selectAttributes.length) this.selectVariation();
        ...
        this.qunatityGroupPlus = function (p) {
          ...
          if (p.stock_quantity == null || p.stock_quantity > p.quantity) p.quantity++;else if (p.stock_quantity == p.quantity) this.shared.translateString("Product Quantity is Limited!").then(function (res) {
            _this2.shared.showAlert(res);
          });
          this.applicationRef.tick(); // console.log(p);
        }; //===============================================================================================================================
        ...
        this.qunatityPlus = function () {
          ...
          if (this.product.stock_quantity == null || this.product.stock_quantity > this.quantity) this.quantity++;else if (this.product.stock_quantity == this.quantity) this.shared.translateString("Product Quantity is Limited!").then(function (res) {
            _this3.shared.showAlert(res);
          });
          this.applicationRef.tick();
        }; //===============================================================================================================================
        //function decreasing the quantity
        ...
        this.events.subscribe('wishListUpdate', function (id, value) {
          if (id == _this4.product.id) _this4.isLiked = value;
        });
        this.storage.get('wishListProducts').then(function (val) {
          _this4.wishArray = val;

          _this4.checkWishList();
        });
        this.enableDisbaleCartButton();
      ...
      _createClass(ProductDetailPage, [{
        ...
        key: "getGroupProducts",
        value: function getGroupProducts() {
          var _this5 = this;
          ...
          try {
            for (var _iterator = this.product.grouped_products[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              var value = _step.value;
              count++;
              this.config.getWoo("products/" + value + "?" + this.config.productsArguments).then(function (data) {
                _this5.groupProducts.push(Object.assign(data, {
                  quantity: 0
                }));
        ...
        value: function getVariations() {
          ...
          try {
            for (var _iterator2 = this.product.variations[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var value = _step2.value;
              this.config.getWoo("products/" + value + "?" + this.config.productsArguments).then(function (data) {
                count++;
                var d = data;

                _this6.variations.push(d);

                _this6.initializeAllVariationAttributes(d); //console.log(count);


                if (count == _this6.product.variations.length) {
                  _this6.loaderProductVariations = false;
        ...
        key: "initializeAllVariationAttributes",
        value: function initializeAllVariationAttributes(p) {
          var ob = {};
          ob.id = p.id;
          ob.select = false;
          ...
          try {
            for (var _iterator3 = this.attributes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              ...
              try {
                for (var _iterator4 = p.attributes[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                  var v2 = _step4.value;
        ...
        key: "sortAllVariationAttributes",
        value: function sortAllVariationAttributes() {
          var array = [];
          ...
          try {
            for (var _iterator5 = this.product.variations[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              ...
              try {
                for (var _iterator6 = this.allVariableAttributes[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                  var v2 = _step6.value;
        ...
        key: "availableOption",
        value: function availableOption(name, val) {
          ...
          try {
            for (var _iterator7 = this.tempAllVariableAttributes[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        value: function sortAttributes() {
          ...
          try {
            for (var _iterator8 = this.selectAttributes[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              var x = _step8.value;
              ...
              try {
                for (var _iterator9 = this.tempAllVariableAttributes[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                  var y = _step9.value;
                  ...
                  if (y[x.key] == x.value || y[x.key] == 'any') {
                    if (count == 0) {
                      ...
                      if (y.select == true) y.select = true;else y.select = false;
                    }
        ...
        key: "getAttributesLength",
        value: function getAttributesLength() {
          var count = 0;
          ...
          try {
            for (var _iterator10 = this.attributes[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
              var a = _step10.value;
        ...
        key: "enableDisbaleCartButton",
        value: function enableDisbaleCartButton() {
          // if (this.product.type == 'external') this.disableCartButton = true;
          // else
          if (this.product.type != 'variable' && this.product.stock_status == 'instock') this.disableCartButton = false;else if (this.selectAttributes.length == this.getAttributesLength() && this.product.stock_status == 'instock') this.disableCartButton = false;else this.disableCartButton = true;
        ...
        value: function checkWishList() {
          ...
          if (this.wishArray != null) {
            ...
            try {
              for (var _iterator11 = this.wishArray[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
        ...
        value: function addToCartProduct() {
          ...
          if (this.product.type == 'grouped') {
            ...
            try {
              for (var _iterator12 = this.groupProducts[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                var a = _step12.value;
            ...
            if (total == 0) this.shared.translateString("Please Add Quantity").then(function (res) {
              _this7.shared.showAlert(res);
            });else {
              ...
              try {
                for (var _iterator13 = this.groupProducts[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        ...
        key: "selectVariation",
        value: function selectVariation() {
          var pId = null;
          ...
          try {
            for (var _iterator14 = this.tempAllVariableAttributes[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
              var i = _step14.value;
          ...
          try {
            for (var _iterator15 = this.variations[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
              var _i = _step15.value;

              if (_i.id == pId) {
                this.selectedVariation = _i;
                break;
              }
            }
          } catch (err) {
          ...
          if (this.selectAttributes != null) this.updateProductDetail(this.selectedVariation);
          console.log(this.product);
        } //===============================================================================================================================

      }, {
        key: "updateProductDetail",
        value: function updateProductDetail(p) {
          // console.log(p);
          var oldProduct = JSON.parse(JSON.stringify(this.getProductData(this.pId)));
        ...
        key: "removeDuplication",
        value: function removeDuplication(array) {
          var a = array.concat();
          console.log(a);
        ...
        value: function quantityChange() {
          ...
          if (this.product.stock_quantity == null) {
            ...
            this.shared.translateString("Product Quantity is Limited!").then(function (res) {
              if (_this8.product.stock_quantity == null) _this8.quantity = 1;else _this8.quantity = parseInt(_this8.product.stock_quantity);

              _this8.shared.showAlert(res);
            });
          }
        ...
        value: function showProductDetail(id) {
          ...
          this.config.getWoo("products/" + id + "?" + this.config.productsArguments).then(function (data) {
            ...
            _this9.shared.singleProductPageData.push(p);

            _this9.navCtrl.navigateForward("product-detail/" + p.id);
          }, function (err) {
            _this9.loading.hide();
        ...
        value: function getRelatedItems() {
          ...
          this.config.getWoo("products/?include=" + this.product.related_ids + "&" + this.config.productsArguments).then(function (data) {
            _this10.releatedItems = data;

            _this10.applicationRef.tick();
          });
        } //===============================================================================================================================
        // <!-- 2.0 updates -->
        ...
        value: function getProductReviews() {
          ...
          this.config.getWoo("products/reviews/?" + this.config.productsArguments + "&product=" + [this.pId]).then(function (data) {
            _this11.reviews = data;

            _this11.applicationRef.tick();
        ...
        value: function totalRating() {
          ...
          try {
            for (var _iterator16 = this.reviews[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
          ...
          this.applicationRef.tick(); //return result;
        } //==============================================================

      }, {
        key: "openStore",
        value: function openStore(value) {
          var _this12 = this;
          ...
          if (this.config.showWcVendorInfo) {
            ...
            this.loading.show();
            this.config.getWithUrl(this.config.url + "/wp-json/dokan/v1/stores/" + this.product.store.id).then(function (data) {
              _this12.loading.hide();

              var d = data;

              _this12.shared.storePageData.push(d);

              var id;
              if (d.ID) id = d.ID;
              if (d.id) id = d.id;

              _this12.navCtrl.navigateForward("/store/" + id);

              _this12.applicationRef.tick();
            });
          }
        }
      }, {
        key: "getWcVendorInfo",
        value: function getWcVendorInfo() {
          var _this13 = this;

          this.loaderWcVendorInfo = true;
          this.config.getWithUrl(this.config.url + "/api/appsettings/get_vendor_info/?insecure=cool&product_id=" + this.product.id).then(function (data) {
            _this13.loaderWcVendorInfo = false;
            var d = data;
            _this13.wcVendorInfo = data.data[0];

            _this13.applicationRef.tick();
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"], src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_4__["SharedDataService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_6__["InAppBrowser"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Events"], _ionic_storage__WEBPACK_IMPORTED_MODULE_9__["Storage"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ApplicationRef"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_8__["SocialSharing"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"]])], ProductDetailPage);
    /***/
  }
}]);
