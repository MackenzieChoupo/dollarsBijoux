...
let BannerComponent = class BannerComponent {
    constructor(shared, navCtrl, config, http, loading) {
        this.shared = shared;
...
let CategoriesComponent = class CategoriesComponent {
    constructor(config, shared, nav, events) {
        this.config = config;
        this.shared = shared;
        this.nav = nav;
        this.events = events;
...
let ProductComponent = class ProductComponent {
    constructor(config, shared, navCtrl, modalCtrl, events, storage, loading) {
        this.config = config;
        this.shared = shared;
        this.navCtrl = navCtrl;
