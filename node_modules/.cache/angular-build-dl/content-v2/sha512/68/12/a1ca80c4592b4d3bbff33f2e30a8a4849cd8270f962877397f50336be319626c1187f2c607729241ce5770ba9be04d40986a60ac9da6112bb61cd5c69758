...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["my-account-my-account-module"], {
  ...
  function srcAppMyAccountMyAccountPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MyAccountPage = /*#__PURE__*/function () {
      function MyAccountPage(http, config, shared, platform, navCtrl, applicationRef, loading) {
        ...
        this.updateInfo = function () {
          ...
          this.config.putAsync("customers/" + this.shared.customerData.id, this.myAccountData).then(function (data) {
            _this.loading.hide();

            _this.shared.login(data);

            _this.applicationRef.tick();

            _this.nav.navigateRoot("/settings");

            _this.shared.toast("Data Updated!");
          }, function (err) {
            _this.shared.toast("Error Updating Data!");
          });
        };
      }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"], src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_4__["SharedDataService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ApplicationRef"], src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"]])], MyAccountPage);
    /***/
  }
}]);
