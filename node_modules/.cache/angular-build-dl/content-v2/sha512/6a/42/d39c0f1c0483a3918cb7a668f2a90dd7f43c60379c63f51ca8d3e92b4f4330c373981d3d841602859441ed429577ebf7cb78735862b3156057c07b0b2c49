...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-products-module"], {
  ...
  function srcAppProductsProductsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductsPage = /*#__PURE__*/function () {
      function ProductsPage(navCtrl, activatedRoute, config, shared, loading, http, events, actionSheet, menuCtrl, applicationRef) {
      ...
      _createClass(ProductsPage, [{
        ...
        value: function selectAttribute(a, v) {
          ...
          try {
            for (var _iterator2 = this.selectedAttributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var x = _step2.value;
              ...
              try {
                for (var _iterator3 = x.list[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                  var y = _step3.value;
