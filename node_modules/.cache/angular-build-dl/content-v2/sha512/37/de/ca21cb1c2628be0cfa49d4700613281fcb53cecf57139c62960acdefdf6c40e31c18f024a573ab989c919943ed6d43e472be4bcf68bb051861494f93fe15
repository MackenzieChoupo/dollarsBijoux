...
var map = {
	...
	"./cart/cart.module": [
		...
		"default~cart-cart-module~order-order-module",
		"cart-cart-module"
	],
	...
	"./home-pages/home/home.module": [
		...
		"default~home-pages-home-home-module~home-pages-home10-home10-module~home-pages-home2-home2-module~ho~d52f8f32",
		"home-pages-home-home-module"
	],
	...
	"./reward-points/reward-points.module": [
...
/* harmony import */ var _ionic_native_admob_free_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/admob-free/ngx */ "./node_modules/@ionic-native/admob-free/ngx/index.js");
...
/* harmony import */ var _modals_login_login_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modals/login/login.page */ "./src/app/modals/login/login.page.ts");
/* harmony import */ var _modals_sign_up_sign_up_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modals/sign-up/sign-up.page */ "./src/app/modals/sign-up/sign-up.page.ts");
/* harmony import */ var _modals_language_language_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modals/language/language.page */ "./src/app/modals/language/language.page.ts");
/* harmony import */ var _modals_currency_list_currency_list_page__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modals/currency-list/currency-list.page */ "./src/app/modals/currency-list/currency-list.page.ts");
...
let AppComponent = class AppComponent {
    constructor(shared, config, router, navCtrl, platform, modalCtrl, statusBar, storage, network, loading, admobFree, events, plt, appVersion, iab, socialSharing, deeplinks, menuCtrl) {
        this.shared = shared;
        this.config = config;
        this.router = router;
        ...
        this.a1 = [
            ...
            },
            {
                ...
                items: [
                    { name: "Nouveautés", url: '/products/0/0/newest' },
                    { name: "En promotion", url: '/products/0/0/sale' },
                    { name: "A la Une", url: '/products/0/0/featured' },
                ],
                expanded: false
            },
        ];
        this.a2 = [
            { name: 'Accueil', icon: 'home', url: 'home', img: 'assets/left-menu-icon/home.png' },
            { name: 'Categories', icon: 'apps', url: 'categories', img: 'assets/left-menu-icon/category.png' },
            {
                name: 'Boutique', icon: 'cash', url: '/products', img: 'assets/left-menu-icon/shop.png',
                items: [
                    { name: "Nouveautés", url: '/products/0/0/newest' },
                    { name: "En promotion", url: '/products/0/0/sale' },
                    { name: "A la Une", url: '/products/0/0/featured' },
        ...
        this.a3 = [
            { name: 'Mes Favoris', icon: 'heart', img: 'assets/left-menu-icon/wishlist.png', url: '/wish-list', value: 'wishListPage' },
            { name: 'Contact', icon: 'call', img: 'assets/left-menu-icon/phone.png', url: '/contact-us', value: 'contactPage' },
        ...
        this.a4 = [
            { name: 'Mes Favoris', icon: 'heart', img: 'assets/left-menu-icon/wishlist.png', url: '/wish-list', value: 'wishListPage' },
            { name: 'Modifier le profil', icon: 'lock', img: 'assets/left-menu-icon/locked.png', url: '/my-account', login: true, value: 'editPage' },
            ...
            { name: 'Mes commandes', icon: 'cart', img: 'assets/left-menu-icon/orders.png', url: '/my-orders', login: true, value: 'myOrdersPage' },
            { name: 'Reward Points', img: 'assets/left-menu-icon/gift.png', icon: 'happy', url: '/reward-points', login: true, value: 'rewardPointsPage' },
            { name: 'Notifications', icon: 'notifications', img: 'assets/left-menu-icon/notifications.png', url: '/notifications', login: true, value: 'scratchCardPage' },
            { name: 'Contact', icon: 'call', img: 'assets/left-menu-icon/phone.png', url: '/contact-us', value: 'contactPage' },
            { name: 'A Propos', icon: 'information-circle', img: 'assets/left-menu-icon/about.png', url: '/about-us', value: 'aboutUsPage' },
            { name: 'Actualités', icon: 'paper', img: 'assets/left-menu-icon/news.png', url: '/news', value: 'newsPage' },
            { name: 'Intro', icon: 'logo-ionic', img: 'assets/left-menu-icon/intro.png', url: '/intro', value: 'introPage' },
        ...
        network.onDisconnect().subscribe(() => {
            ...
            this.shared.showAlertWithTitle("Veuillez vous connecter à Internet!", "Déconnecté");
    ...
    openPage(page) {
        ...
        if (page == 'home')
            ...
            this.openCategoryPage();
        else if (page == '/products/0/0/newest')
            this.navCtrl.navigateForward(page);
        else if (page == '/products/0/0/sale')
            this.navCtrl.navigateForward(page);
    ...
    getStatusBarColor() {
        let headerColor = jquery__WEBPACK_IMPORTED_MODULE_14__('#primary').css('color');
        ...
        let color = jquery__WEBPACK_IMPORTED_MODULE_14__('#my').css('color');
        let rgb = color;
    ...
    getSingleProductDetail(slug) {
        this.loading.show();
        this.config.getWoo("products/" + "?" + this.config.productsArguments + "&slug=" + slug).then((data) => {
            this.loading.hide();
            let p = data[0];
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_5__["SharedDataService"],
        ...
        _ionic_native_admob_free_ngx__WEBPACK_IMPORTED_MODULE_8__["AdMobFree"],
...
/* harmony import */ var _ionic_native_themeable_browser_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/themeable-browser/ngx */ "./node_modules/@ionic-native/themeable-browser/ngx/index.js");
...
/* harmony import */ var _ionic_native_deeplinks_ngx__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @ionic-native/deeplinks/ngx */ "./node_modules/@ionic-native/deeplinks/ngx/index.js");
/* harmony import */ var _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/http/ngx */ "./node_modules/@ionic-native/http/ngx/index.js");
...
/* harmony import */ var _providers_config_config_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../providers/config/config.service */ "./src/providers/config/config.service.ts");
/* harmony import */ var src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! src/providers/shared-data/shared-data.service */ "./src/providers/shared-data/shared-data.service.ts");
/* harmony import */ var src_providers_location_data_location_data_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! src/providers/location-data/location-data.service */ "./src/providers/location-data/location-data.service.ts");
...
/* harmony import */ var _components_menu_component_menu_component_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../components/menu-component/menu-component.component */ "./src/components/menu-component/menu-component.component.ts");
...
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
/* harmony import */ var _modals_refund_policy_refund_policy_module__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./modals/refund-policy/refund-policy.module */ "./src/app/modals/refund-policy/refund-policy.module.ts");
/* harmony import */ var _modals_currency_list_currency_list_module__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./modals/currency-list/currency-list.module */ "./src/app/modals/currency-list/currency-list.module.ts");
/* harmony import */ var _modals_login_login_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./modals/login/login.module */ "./src/app/modals/login/login.module.ts");
/* harmony import */ var _modals_sign_up_sign_up_module__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./modals/sign-up/sign-up.module */ "./src/app/modals/sign-up/sign-up.module.ts");
/* harmony import */ var _modals_forgot_password_forgot_password_module__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./modals/forgot-password/forgot-password.module */ "./src/app/modals/forgot-password/forgot-password.module.ts");
/* harmony import */ var _modals_privacy_policy_privacy_policy_module__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./modals/privacy-policy/privacy-policy.module */ "./src/app/modals/privacy-policy/privacy-policy.module.ts");
/* harmony import */ var _modals_select_country_select_country_module__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./modals/select-country/select-country.module */ "./src/app/modals/select-country/select-country.module.ts");
/* harmony import */ var _modals_select_zones_select_zones_module__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./modals/select-zones/select-zones.module */ "./src/app/modals/select-zones/select-zones.module.ts");
/* harmony import */ var _modals_scratch_card_scratch_card_module__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./modals/scratch-card/scratch-card.module */ "./src/app/modals/scratch-card/scratch-card.module.ts");
/* harmony import */ var _modals_term_services_term_services_module__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./modals/term-services/term-services.module */ "./src/app/modals/term-services/term-services.module.ts");
/* harmony import */ var _modals_language_language_module__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./modals/language/language.module */ "./src/app/modals/language/language.module.ts");
/* harmony import */ var _modals_blank_modal_blank_modal_module__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./modals/blank-modal/blank-modal.module */ "./src/app/modals/blank-modal/blank-modal.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _components_menu_component_menu_component_component__WEBPACK_IMPORTED_MODULE_27__["MenuComponentComponent"],
        ],
        entryComponents: [],
        imports: [
            ...
            src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_30__["PipesModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_29__["FormsModule"],
            _modals_blank_modal_blank_modal_module__WEBPACK_IMPORTED_MODULE_42__["BlankModalPageModule"],
            _modals_language_language_module__WEBPACK_IMPORTED_MODULE_41__["LanguagePageModule"],
            _modals_refund_policy_refund_policy_module__WEBPACK_IMPORTED_MODULE_31__["RefundPolicyPageModule"],
            _modals_currency_list_currency_list_module__WEBPACK_IMPORTED_MODULE_32__["CurrencyListPageModule"],
            _modals_login_login_module__WEBPACK_IMPORTED_MODULE_33__["LoginPageModule"],
            _modals_sign_up_sign_up_module__WEBPACK_IMPORTED_MODULE_34__["SignUpPageModule"],
            _modals_forgot_password_forgot_password_module__WEBPACK_IMPORTED_MODULE_35__["ForgotPasswordPageModule"],
            _modals_privacy_policy_privacy_policy_module__WEBPACK_IMPORTED_MODULE_36__["PrivacyPolicyPageModule"],
            ...
            _modals_scratch_card_scratch_card_module__WEBPACK_IMPORTED_MODULE_39__["ScratchCardPageModule"],
        ],
        providers: [
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _providers_config_config_service__WEBPACK_IMPORTED_MODULE_21__["ConfigService"],
            src_providers_location_data_location_data_service__WEBPACK_IMPORTED_MODULE_23__["LocationDataService"],
            src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_22__["SharedDataService"],
            ...
            _ionic_native_themeable_browser_ngx__WEBPACK_IMPORTED_MODULE_11__["ThemeableBrowser"],
            ...
            _ionic_native_deeplinks_ngx__WEBPACK_IMPORTED_MODULE_18__["Deeplinks"],
            _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_19__["HTTP"],
...
/* harmony import */ var _blank_modal_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blank-modal.page */ "./src/app/modals/blank-modal/blank-modal.page.ts");
...
BlankModalPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./blank-modal.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/blank-modal/blank-modal.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./blank-modal.page.scss */ "./src/app/modals/blank-modal/blank-modal.page.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _currency_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./currency-list.page */ "./src/app/modals/currency-list/currency-list.page.ts");
...
CurrencyListPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _currency_list_page__WEBPACK_IMPORTED_MODULE_6__["CurrencyListPage"]
        ]
    })
...
let CurrencyListPage = class CurrencyListPage {
    constructor(loading, config, shared, modalCtrl, http) {
        this.loading = loading;
        this.config = config;
        this.shared = shared;
        this.modalCtrl = modalCtrl;
    ...
    getListOfCurrency() {
        this.loading.show();
        this.config.getWithUrl(this.config.url + "/api/appsettings/get_all_currencies/?insecure=cool").then((data) => {
            this.loading.hide();
...
CurrencyListPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./currency-list.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/currency-list/currency-list.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./currency-list.page.scss */ "./src/app/modals/currency-list/currency-list.page.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _forgot_password_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./forgot-password.page */ "./src/app/modals/forgot-password/forgot-password.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
ForgotPasswordPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _forgot_password_page__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordPage"]
        ]
    })
...
let ForgotPasswordPage = class ForgotPasswordPage {
    constructor(loading, http, config, shared, modalCtrl) {
        this.loading = loading;
        this.http = http;
        this.config = config;
        this.shared = shared;
    ...
    forgetPassword() {
        this.loading.show();
        this.errorMessage = '';
        this.http.get(this.config.url + '/api/appusers/forgot_password/?insecure=cool&email=' + this.formData.customers_email_address).subscribe((data) => {
            this.loading.hide();
            console.log(data);
...
ForgotPasswordPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./forgot-password.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/forgot-password/forgot-password.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./forgot-password.page.scss */ "./src/app/modals/forgot-password/forgot-password.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _language_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./language.page */ "./src/app/modals/language/language.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
LanguagePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        exports: [
            _language_page__WEBPACK_IMPORTED_MODULE_6__["LanguagePage"]
        ],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/providers/loading/loading.service */ "./src/providers/loading/loading.service.ts");
/* harmony import */ var src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/providers/config/config.service */ "./src/providers/config/config.service.ts");
/* harmony import */ var src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/providers/shared-data/shared-data.service */ "./src/providers/shared-data/shared-data.service.ts");
...
let LanguagePage = class LanguagePage {
    constructor(loading, modalCont, config, shared) {
        this.loading = loading;
        this.modalCont = modalCont;
        this.config = config;
        this.shared = shared;
        ...
        this.languageList = [
            ...
            { "name": "Francais", "code": "fr", "image": "assets/flags/uae.jpg", "direction": "ltr" }
        ];
...
LanguagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./language.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/language/language.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./language.page.scss */ "./src/app/modals/language/language.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"],
        src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_5__["SharedDataService"]])
], LanguagePage);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./login.page */ "./src/app/modals/login/login.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/providers/shared-data/shared-data.service */ "./src/providers/shared-data/shared-data.service.ts");
/* harmony import */ var _sign_up_sign_up_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../sign-up/sign-up.page */ "./src/app/modals/sign-up/sign-up.page.ts");
/* harmony import */ var _forgot_password_forgot_password_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../forgot-password/forgot-password.page */ "./src/app/modals/forgot-password/forgot-password.page.ts");
...
/* harmony import */ var src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/providers/loading/loading.service */ "./src/providers/loading/loading.service.ts");
...
let LoginPage = class LoginPage {
    constructor(http, config, modalCtrl, loading, shared, fb, applicationRef, navCtrl, events, navParams) {
        this.http = http;
        this.config = config;
        this.modalCtrl = modalCtrl;
        this.loading = loading;
    ...
    getUserData(c, type) {
        ...
        this.config.getWoo("customers/" + id + "?" + this.config.productsArguments).then((data) => {
            this.loading.hide();
            let dat = data;
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-login',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/login/login.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.page.scss */ "./src/app/modals/login/login.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"],
        src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_9__["LoadingService"],
        src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_5__["SharedDataService"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _privacy_policy_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./privacy-policy.page */ "./src/app/modals/privacy-policy/privacy-policy.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
PrivacyPolicyPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _privacy_policy_page__WEBPACK_IMPORTED_MODULE_6__["PrivacyPolicyPage"]
        ]
    })
...
PrivacyPolicyPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./privacy-policy.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/privacy-policy/privacy-policy.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./privacy-policy.page.scss */ "./src/app/modals/privacy-policy/privacy-policy.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"]])
], PrivacyPolicyPage);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _refund_policy_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./refund-policy.page */ "./src/app/modals/refund-policy/refund-policy.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
RefundPolicyPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _refund_policy_page__WEBPACK_IMPORTED_MODULE_6__["RefundPolicyPage"]
        ]
    })
...
RefundPolicyPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./refund-policy.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/refund-policy/refund-policy.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./refund-policy.page.scss */ "./src/app/modals/refund-policy/refund-policy.page.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _scratch_card_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scratch-card.page */ "./src/app/modals/scratch-card/scratch-card.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
let ScratchCardPage = class ScratchCardPage {
    constructor(navCtrl, popoverCtrl, navParams, events) {
        this.navCtrl = navCtrl;
...
ScratchCardPage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"] },
...
ScratchCardPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./scratch-card.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/scratch-card/scratch-card.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./scratch-card.page.scss */ "./src/app/modals/scratch-card/scratch-card.page.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _select_country_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./select-country.page */ "./src/app/modals/select-country/select-country.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonSearchbar"])
], SelectCountryPage.prototype, "searchBar", void 0);
SelectCountryPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-select-country',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./select-country.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/select-country/select-country.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./select-country.page.scss */ "./src/app/modals/select-country/select-country.page.scss")).default]
    }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _select_zones_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./select-zones.page */ "./src/app/modals/select-zones/select-zones.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
SelectZonesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./select-zones.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/select-zones/select-zones.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./select-zones.page.scss */ "./src/app/modals/select-zones/select-zones.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavParams"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _sign_up_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sign-up.page */ "./src/app/modals/sign-up/sign-up.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
SignUpPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _sign_up_page__WEBPACK_IMPORTED_MODULE_6__["SignUpPage"]
        ]
    })
], SignUpPageModule);
...
/* harmony import */ var src_providers_loading_loading_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/providers/loading/loading.service */ "./src/providers/loading/loading.service.ts");
/* harmony import */ var src_providers_shared_data_shared_data_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/providers/shared-data/shared-data.service */ "./src/providers/shared-data/shared-data.service.ts");
/* harmony import */ var _term_services_term_services_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../term-services/term-services.page */ "./src/app/modals/term-services/term-services.page.ts");
/* harmony import */ var _refund_policy_refund_policy_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../refund-policy/refund-policy.page */ "./src/app/modals/refund-policy/refund-policy.page.ts");
/* harmony import */ var _privacy_policy_privacy_policy_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../privacy-policy/privacy-policy.page */ "./src/app/modals/privacy-policy/privacy-policy.page.ts");
...
let SignUpPage = class SignUpPage {
    constructor(http, config, modalCtrl, loading, shared, platform) {
        this.http = http;
        this.config = config;
        this.modalCtrl = modalCtrl;
        this.loading = loading;
    ...
    createAccount() {
        this.loading.show();
        this.http.get(this.config.url + '/api/get_nonce/?controller=appusers&method=register').subscribe((data) => {
    ...
    signUp(nonce) {
        ...
        this.http.post(this.config.url + '/api/appusers/register/?insecure=cool', formData).subscribe((data) => {
            this.loading.hide();
            if (data.status == "ok") {
...
SignUpPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./sign-up.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/sign-up/sign-up.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./sign-up.page.scss */ "./src/app/modals/sign-up/sign-up.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"],
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/fesm5.js");
/* harmony import */ var _term_services_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./term-services.page */ "./src/app/modals/term-services/term-services.page.ts");
/* harmony import */ var src_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/pipes/pipes.module */ "./src/pipes/pipes.module.ts");
...
TermServicesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [
            _term_services_page__WEBPACK_IMPORTED_MODULE_6__["TermServicesPage"]
        ]
    })
...
TermServicesPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./term-services.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modals/term-services/term-services.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./term-services.page.scss */ "./src/app/modals/term-services/term-services.page.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"],
        src_providers_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"]])
], TermServicesPage);
...
MenuComponentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./menu-component.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/components/menu-component/menu-component.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./menu-component.component.scss */ "./src/components/menu-component/menu-component.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CurencyPipe", function() { return CurencyPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
CurencyPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _curency_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./curency.pipe */ "./src/pipes/curency.pipe.ts");
/* harmony import */ var _translate_app_translate_app_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./translate-app/translate-app.pipe */ "./src/pipes/translate-app/translate-app.pipe.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TranslateAppPipe", function() { return TranslateAppPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
TranslateAppPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'translate'
    }),
...
let ConfigService = class ConfigService {
    constructor(http, storage, platform, applicationRef, events, httpNative) {
        this.http = http;
        this.storage = storage;
        this.platform = platform;
        this.applicationRef = applicationRef;
    ...
    putAsync(url, dataToPost) {
        return new Promise(resolve => {
            ...
            if (this.platform.is('cordova')) {
                ...
                this.http.put(request.url, dataToPost, request.headers).subscribe((data) => {
                    resolve(data);
                }, (err) => {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _config_config_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../config/config.service */ "./src/providers/config/config.service.ts");
...
/* harmony import */ var _loading_loading_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../loading/loading.service */ "./src/providers/loading/loading.service.ts");
...
let SharedDataService = class SharedDataService {
    constructor(http, config, storage, loading, events, platform, spinnerDialog, oneSignal, alertCtrl, toastCtrl, themeableBrowser, applicationRef, splashScreen) {
        this.http = http;
        this.config = config;
        this.storage = storage;
        this.loading = loading;
        ...
        this.http.get('assets/i18n/' + localStorage.languageCode + ".json").subscribe((data) => {
        ...
        this.translateString(this.checkOutPageText).then((res) => { this.checkOutPageText = res; });
    ...
    onStart() {
        //banners
        this.config.getWithUrl(this.config.url + '/api/appsettings/get_all_banners/?insecure=cool').then((data) => {
            this.banners = data.data;
        });
        // //getting tab 1 products?status=publish
        this.config.getWoo("products?status=publish" + "&" + this.config.productsArguments).then((data) => {
            this.tab1 = data;
            this.applicationRef.tick();
        });
        //getting tab 2
        this.config.getWoo("products?on_sale=true&status=publish" + "&" + this.config.productsArguments).then((data) => {
            this.tab2 = data;
            this.applicationRef.tick();
        });
        //getting tab 3
        this.config.getWoo("products?featured=true&status=publish" + "&" + this.config.productsArguments).then((data) => {
            this.tab3 = data;
            this.applicationRef.tick();
        });
        ...
        //content pages
        this.config.getWithUrl(url).then((data) => {
            let d = data;
            for (let value of d) {
    ...
    getVendorList() {
        if (this.config.showVendorInfo) {
            this.config.getWithUrl(this.config.url + "/api/appsettings/get_featured_dokan_vendors_list/?insecure=cool").then((data) => {
                if (this.vendors[0] == 1)
                    this.vendors = [];
            ...
            this.config.getWithUrl(this.config.url + "/api/appsettings/get_featured_wcvendors_list/?insecure=cool").then((data) => {
                if (this.vendors[0] == 1)
                    this.vendors = [];
    ...
    getAllCategories(page) {
        ...
        this.config.getWoo("products/categories?per_page=50&page=" + page + "&" + this.config.productsArguments).then((data) => {
            let dat = data;
    ...
    toast(msg) {
        this.translateString(msg).then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    openCheckoutWebview(data) {
        ...
        this.uploadDataToServer(data).then((id) => {
            ...
            b.on('loadstart').subscribe(res => {
                this.translateString('Loading').then((res) => {
    ...
    //=================================================
    showAlert(text) {
        this.translateArray([text, "ok", "Alert"]).then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(res);
    ...
    showAlertWithTitle(text, title) {
        this.translateArray([text, "ok", title]).then((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
SharedDataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"],
        _config_config_service__WEBPACK_IMPORTED_MODULE_2__["ConfigService"],
        _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"],
        _loading_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"],
...
module.exports = __webpack_require__(/*! /home/morel/Bureau/solution android dollars bijoux/App Source Code/src/main.ts */"./src/main.ts");
